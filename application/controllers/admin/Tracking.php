...
class Tracking extends MY_Controller {
	...
	public function index()
	{
	   ifPermissions('tracking_list');
		...
		$this->load->view('admin/tracking/list', $this->page_data);
	}
	...
	public function view($id)
	{
		...
		$this->load->view('admin/tracking/view', $this->page_data);
	}

	/*public function add(){
		ifPermissions('tracking_add');
		$this->load->view('admin/tracking/add', $this->page_data);
	}

	public function edit($id){
		ifPermissions('tracking_edit');
		$this->page_data['permission'] = $this->tracking_model->getById($id);
		$this->load->view('admin/tracking/edit', $this->page_data);
	}
