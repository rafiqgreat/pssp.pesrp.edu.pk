...
<ul class="nav nav-pills nav-sidebar flex-column nav-legacy" data-widget="treeview" role="menu" data-accordion="false">
  ...
  <?php if (hasPermissions('school_management')): ?>
    <li class="nav-item">
      <a href="<?php echo url('schoolchain') ?>" class="nav-link <?php echo ($page->menu == 'schoolchain') ? 'active' : '' ?>">
        <i class="nav-icon fas fa-user"></i>
        <p>
  ...
  <?php if (hasPermissions('school_management')): ?>
    <li class="nav-item has-treeview <?php echo ($page->menu == 'school') ? 'menu-open' : '' ?>">
      ...
      <ul class="nav nav-treeview">
        <li class="nav-item">
          <a href="<?php echo url('school') ?>" class="nav-link <?php echo ($page->submenu == '') ? 'active' : '' ?>">
            <i class="far fa-circle nav-icon"></i>
            <p> <?php echo lang('school_list') ?> </p>
          </a>
        </li>
        <li class="nav-item">
          <a href="<?php echo url('school/import') ?>" class="nav-link <?php echo ($page->submenu == 'import') ? 'active' : '' ?>">
            <i class="far fa-circle nav-icon"></i>
            <p> <?php echo lang('school_import') ?></p>
          </a>
        </li>
        <?php /*?><li class="nav-item">
        <a href="<?php echo url('schoolchain') ?>" class="nav-link <?php echo ($page->submenu=='schoolchain')?'active':'' ?>">
  ...
  <?php if (hasPermissions('location_management')): ?>
    <li class="nav-item has-treeview <?php echo ($page->menu == 'location') ? 'menu-open' : '' ?>">
      ...
      <ul class="nav nav-treeview">
        <li class="nav-item">
          <a href="<?php echo url('location') ?>" class="nav-link <?php echo ($page->submenu == '') ? 'active' : '' ?>">
            <i class="far fa-circle nav-icon"></i>
            <p> <?php echo lang('state_list') ?> </p>
          </a>
        </li>
        <li class="nav-item">
          <a href="<?php echo url('location/district') ?>" class="nav-link <?php echo ($page->submenu == 'district') ? 'active' : '' ?>">
            <i class="far fa-circle nav-icon"></i>
            <p> <?php echo lang('district_list') ?> </p>
          </a>
        </li>
        <li class="nav-item">
          <a href="<?php echo url('location/tehsil') ?>" class="nav-link <?php echo ($page->submenu == 'tehsil') ? 'active' : '' ?>">
            <i class="far fa-circle nav-icon"></i>
  ...
  <li class="nav-item">
    <a href="<?php echo url('/logout') ?>" class="nav-link <?php echo ($page->menu == 'logout') ? 'active' : '' ?>">
      <i class="nav-icon fas fa-user"></i>
      <p>
        <?php echo 'Logout'; ?>
      </p>
