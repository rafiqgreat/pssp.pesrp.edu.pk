  ...
  <div class="card">
    <div class="card-body login-card-body">
     ...
     <?php echo form_close(); ?>
      ...
      <p class="mt-3 mb-1">
        <a href="<?php echo url('admin/login') ?>"><?php echo lang('signin') ?></a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
...
<div class="login-box">
  ...
  <div class="login-logo">
    <a href="<?php echo url('/admin/') ?>"><b>Admin</b> Panel</a>
  </div>
  ...
  <hr>
    ...
    <a href="<?php echo url('admin/login') ?>"> <i class="fa fa-chevron-left"></i> Go To Login</a><br>
