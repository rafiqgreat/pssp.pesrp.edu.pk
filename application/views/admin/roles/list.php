  ...
  <div class="card">
    <div class="card-header with-border">
      ...
      <div class="card-tools pull-right">
        <a href="<?php echo url('admin/roles/add') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus pr-1"></i> <?php echo lang('create_role') ?></a>
      </div>
            ...
            <tr>
              ...
              <td>
                <?php if (hasPermissions('roles_edit')): ?>
                  <a href="<?php echo url('admin/roles/edit/'.$row->id) ?>" class="btn btn-sm btn-default" title="Edit User Role" data-toggle="tooltip"><i class="fas fa-edit"></i></a>
                <?php endif ?>
              </td>
            </tr>
          <?php endforeach ?>
