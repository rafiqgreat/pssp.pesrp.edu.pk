    ...
    <div class="card-header with-border">
      ...
      <div class="card-tools pull-right">
        <?php if (hasPermissions('school_add')): ?>
          <a href="<?php echo url('admin/school/add') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> <?php echo lang('new_school') ?></a>
        <?php endif ?>
      </div>
    </div>
    <div class="card-body">
            ...
            <tr>
              ...
              <td>
                <?php if (hasPermissions('school_edit')): ?>
                  <a href="<?php echo url('admin/school/edit/'.$row->school_id) ?>" class="btn btn-sm btn-default" title="<?php echo lang('school_edit') ?>" data-toggle="tooltip"><i class="fas fa-edit"></i></a>
                <?php endif ?>
                <?php if (hasPermissions('school_delete')): ?>
                  <a href="<?php echo url('admin/school/delete/'.$row->school_id) ?>" class="btn btn-sm btn-default" onclick='return confirm("Do you really want to delete this school ? \nIt may cause errors where it is currently being used !!")' title="<?php echo lang('school_delete') ?>" data-toggle="tooltip"><i class="fa fa-trash"></i></a>
                <?php endif ?>
              </td>
            </tr>
          <?php endforeach ?>
