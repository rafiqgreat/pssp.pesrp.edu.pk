...
<section class="content">
  ...
  <div class="row">
    ...
    <div class="col-sm-3">
      ...
      <?php include VIEWPATH.'/admin/settings/sidebar.php'; ?>
    ...
    <div class="col-sm-9">
      ...
      <div class="card">
        ...
        <?php echo form_open_multipart('admin/settings/update_email_templates/'.$template->id, [ 'class' => 'form-validate', 'autocomplete' => 'off', 'method' => 'post' ]); ?>

        <div class="card-header with-border">
          <h3 class="card-title"><?php echo lang('email_templates') ?></h3>

          <div class="card-tools pull-right">
            <a href="<?php echo url('admin/settings/email_templates') ?>" class="btn btn-sm btn-default"><i class="fa fa-arrow-left"></i> &nbsp;&nbsp; <?php echo lang('email_templates') ?></a>
          </div>
        ...
        <div class="card-footer">
          ...
          <a href="<?php echo url('admin/settings/email_templates') ?>" class="btn btn-flat btn-danger pull-right"><?php echo lang('cancel') ?></a>
        </div>
        <!-- /.card-footer-->
