        ...
        <tbody>
          ...
          <?php foreach ($this->templates_model->get() as $row): ?>
            <tr>
              ...
              <td>
                  <a href="<?php echo url('admin/settings/edit_email_templates/'.$row->id) ?>" class="btn btn-sm btn-default" title="<?php echo lang('edit') ?>" data-toggle="tooltip"><i class="fas fa-edit"></i></a>
              </td>
            </tr>
          <?php endforeach ?>
