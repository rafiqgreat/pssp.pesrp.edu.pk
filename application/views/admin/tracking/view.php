      ...
      <div class="row mb-2">
         ...
         <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               ...
               <li class="breadcrumb-item"><a href="<?php echo url('/admin/tracking') ?>"> <?php echo lang('tracking') ?></a></li>
...
<section class="content"> 
   ...
   <div class="card">
      <div class="card-header with-border">
         ...
         <div class="card-tools pull-right"> <a href="<?php echo url('admin/tracking') ?>" class="btn btn-flat btn-default btn-sm"><i class="fa fa-arrow-left"></i> &nbsp;&nbsp; <?php echo lang('tracking') ?></a> </div>
      </div>
