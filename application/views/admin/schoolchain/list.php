              ...
              <div class="card-header d-flex p-0">
                ...
                <div class="ml-auto p-2">
                    <?php if (hasPermissions('schoolchain_add')): ?>
                      <a href="<?php echo url('admin/schoolchain/add') ?>" class="btn btn-primary btn-sm"><span class="pr-1"><i class="fa fa-plus"></i></span> <?php echo lang('new_schoolchain') ?></a>
                    <?php endif ?>
                </div>
              </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <?php if (hasPermissions('schoolchain_edit')): ?>
                          <a href="<?php echo url('admin/schoolchain/edit_schoolchain/'.$row->schoolchain_id) ?>" class="btn btn-sm btn-default" title="<?php echo lang('schoolchain_edit') ?>" data-toggle="tooltip"><i class="fas fa-edit"></i></a>
                        <?php endif ?>
                        
                        <?php if (hasPermissions('schoolchain_delete')): ?>
                        
                          <a href="<?php echo url('admin/schoolchain/delete/'.$row->schoolchain_id); ?>" class="btn btn-sm btn-default" onclick='return confirm("Do you really want to delete this schoolchain ? \nIt may cause errors where it is currently being used !!")' title="<?php echo lang('schoolchain_delete') ?>" data-toggle="tooltip"><i class="fa fa-trash"></i></a>
