...
<ul class="nav nav-pills nav-sidebar flex-column nav-legacy" data-widget="treeview" role="menu" data-accordion="false">
  ...
  <?php endif ?>
  <?php //if (hasPermissions('app_management')): ?>
    <li class="nav-item has-treeview <?php echo ($page->menu == 'app_management') ? 'menu-open' : '' ?>">
      <a href="#" class="nav-link  <?php echo ($page->menu == 'app_management') ? 'active' : '' ?>">
        <i class="nav-icon fas fa-cog"></i>
        <p>
          <?php echo 'Application Mgmt' ?>
          <i class="right fas fa-angle-left"></i>
        </p>
      </a>
      <ul class="nav nav-treeview">
        <li class="nav-item">
          <a href="<?php echo url('admin/app_management/young_ent_list') ?>" class="nav-link <?php echo ($page->submenu == 'young_ent_list') ? 'active' : '' ?>">
            <i class="far fa-circle nav-icon"></i>
            <p> <?php echo 'Young Entrepreneur' ?> </p>
          </a>
        </li>
        <li class="nav-item">
          <a href="<?php echo url('admin/app_management/indiv_list') ?>" class="nav-link <?php echo ($page->submenu == 'indiv_list') ? 'active' : '' ?>">
            <i class="far fa-circle nav-icon"></i>
            <p> <?php echo 'Individual' ?> </p>
          </a>
        </li>
        <li class="nav-item">
        <?php /*echo url('admin/app_management/edu_tech_list')*/ ?>
          <a href="#" class="nav-link <?php echo ($page->submenu == 'edu_tech_list') ? 'active' : '' ?>">
            <i class="far fa-circle nav-icon"></i>
            <p> <?php echo 'Ed Tech Firm' ?> </p>
          </a>
        </li>
        <li class="nav-item">
        	<?php /*echo url('admin/app_management/edu_chain_list')*/ ?>
          <a href="#" class="nav-link <?php echo ($page->submenu == 'edu_chain_list') ? 'active' : '' ?>">
            <i class="far fa-circle nav-icon"></i>
            <p> <?php echo 'Education Chain' ?> </p>
          </a>
        </li>
        <li class="nav-item">
        	<?php /*echo url('admin/app_management/ngos_list')*/ ?>
          <a href="#" class="nav-link <?php echo ($page->submenu == 'ngos_list') ? 'active' : '' ?>">
            <i class="far fa-circle nav-icon"></i>
            <p> <?php echo 'NGOs' ?> </p>
          </a>
        </li>
