    ...
    <div class="card-header with-border">
      ...
      <div class="card-tools pull-right">
        <?php if (hasPermissions('permissions_add')): ?>
          <a href="<?php echo url('admin/permissions/add') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> <?php echo lang('create_permission') ?></a>
        <?php endif ?>
      </div>
            ...
            <tr>
              ...
              <td>
                <?php if (hasPermissions('permissions_edit')): ?>
                  <a href="<?php echo url('admin/permissions/edit/'.$row->id) ?>" class="btn btn-sm btn-default" title="<?php echo lang('edit_permission') ?>" data-toggle="tooltip"><i class="fas fa-edit"></i></a>
                <?php endif ?>
                <?php if (hasPermissions('permissions_delete')): ?>
                  <a href="<?php echo url('admin/permissions/delete/'.$row->id) ?>" class="btn btn-sm btn-default" onclick='return confirm("Do you really want to delete this permissions ? \nIt may cause errors where it is currently being used !!")' title="<?php echo lang('delete_permission') ?>" data-toggle="tooltip"><i class="fa fa-trash"></i></a>
                <?php endif ?>
              </td>
            </tr>
          <?php endforeach ?>
