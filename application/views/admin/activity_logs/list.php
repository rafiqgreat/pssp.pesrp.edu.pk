            ...
            <div class="row">
                ...
                <div class="col-sm-2 text-right">
                  <div class="form-group" style="margin-top: 25px;">
                    <a href="<?php echo url('/admin/activity_logs') ?>" class="btn btn-danger"><?php echo lang('reset') ?></a>
            ...
            <tr>
              ...
              <td>
                <?php if (hasPermissions('activity_log_view')): ?>
                  ...
                  <?php if ($row->user > 0): ?>
                    <a href="<?php echo url('admin/users/view/'.$row->user) ?>" class="btn btn-sm btn-default" title="View User" target="_blank" data-toggle="tooltip"><i class="fa fa-user"></i></a>
                  <?php endif ?>
                <?php endif ?>
              </td>
            </tr>
