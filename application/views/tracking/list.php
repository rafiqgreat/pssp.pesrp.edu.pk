    ...
    <div class="card-header with-border">
      ...
      <?php /*?><div class="card-tools pull-right">
        <?php if (hasPermissions('tracking_add')): ?>
          <a href="<?php echo url('tracking/add') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> <?php echo lang('create_permission') ?></a>
        <?php endif ?>
      </div><?php */?>
            ...
            <tr>
              ...
              <td>
                <?php if (hasPermissions('tracking_view')): ?>
                  <a href="<?php echo url('tracking/view/'.$row->tr_id) ?>" class="btn btn-sm btn-default" title="<?php echo lang('view_tracking') ?>" data-toggle="tooltip"><i class="fas fa-eye"></i></a>
                <?php endif ?>
              </td>
            </tr>
          <?php endforeach ?>
