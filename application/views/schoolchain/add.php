...
<section class="content">
  ...
  <div class="card">
    ...
    <?php echo form_open_multipart('schoolchain/save_schoolchain', [ 'class' => 'form-validate' ], ); ?>
    <div class="card-body">
    ...
    <div class="card-footer">
      <div class="row">
        <div class="col"><a href="<?php echo url('location/schoolchain') ?>" onclick="return confirm('Are you sure you want to leave?')" class="btn btn-flat btn-danger"> <?php echo lang('cancel') ?></a></div>
