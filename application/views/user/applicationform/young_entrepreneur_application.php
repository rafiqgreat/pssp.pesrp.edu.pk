          ...
          <div class="collapse mt-3 border rounded p-3 bg-light show" id="leadApplicantDetails">
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                ...
                <input type="text" class="form-control" name="ye_lead_address" id="ye_lead_address" required placeholder="Enter Postal Address" />
              </div>
            </div>
            ...
            <div class="row mb-3">
              <div class="col-md-4">
                ...
                <input type="text" class="form-control" name="ye_lead_email" id="ye_lead_email" required placeholder="Enter Email" />
              </div>
            </div>
          </div>
        </div>
