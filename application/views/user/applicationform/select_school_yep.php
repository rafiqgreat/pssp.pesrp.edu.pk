  ...
  <div class="card">
    ...
    <!-- Accordion Button -->
            <button class="btn btn-primary w-100 d-flex justify-content-between align-items-center"
                ...
                <?php if(isset($data_young_ent['ye_school_1'])&&$data_young_ent['ye_school_1']!=NULL){?>disabled="disabled"<?php }?>>
                <span>Search</span>
       ...
       <?php echo form_open_multipart('user/applicationform/save_school', ['class' => 'form-validate']); ?>
