...
<div class="login-logo">
    <a href="<?php echo url('/user/') ?>"><?php echo setting('company_name') ?></a>
  </div>
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <?php echo form_open('/user/login/set_new_password', ['method' => 'POST', 'autocomplete' => 'off']); ?> 
     ...
     <?php echo form_close(); ?>
      ...
      <p class="mt-3 mb-1">
        <a href="<?php echo url('user/login') ?>"><?php echo lang('signin') ?></a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
...
<div class="login-box">
  ...
  <div class="login-logo">
    <a href="<?php echo url('/user/') ?>"><b>Applicant</b> Panel</a>
  </div>
  ...
  <hr>
    ...
    <a href="<?php echo url('user/login') ?>"> <i class="fa fa-chevron-left"></i> Go To Login</a><br>
