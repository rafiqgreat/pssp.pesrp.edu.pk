            	...
            	<div class="row col-12">
                    ...
                    <div class="flex flex-wrap gap-2 mt-2 ml-4">
                        <label class="flex items-center">
                            <input type="radio" class="form-radio h-4 w-4 text-indigo-600" name="role" value="2" checked>
                            <span class="ml-2 text-gray-700">Young Entrepreneur</span>
                        </label>
                        <label class="flex items-center ml-4">
                            <input type="radio" class="form-radio h-4 w-4 text-indigo-600" name="role" value="3">
                            <span class="ml-2 text-gray-700">Individual</span>
                        </label>
                        <label class="flex items-center ml-4">
                            <input type="radio" class="form-radio h-4 w-4 text-indigo-600" name="role" value="4">
                            <span class="ml-2 text-gray-700">Ed Tech Firm</span>
                        </label>
                        <label class="flex items-center ml-4">
                            <input type="radio" class="form-radio h-4 w-4 text-indigo-600" name="role" value="5">
