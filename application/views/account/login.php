  ...
  <main class="flex-grow container mx-auto mt-1 md:mt-1 px-2 py-4 ">
    ...
    <div class="grid grid-cols-1 md:grid-cols-[60%_40%] gap-8 items-center pr-5">
      ...
      <div class="bg-white shadow-lg rounded-lg p-2 md:pr-12 pl-12 pt-4 pb-4">
        ...
        <?php echo form_open('/login/check', ['method' => 'POST', 'autocomplete' => 'off', 'class' => 'space-y-4']); ?>
        ...
        <!-- Register Link -->
        <p class="pl-10 pr-10">
          <a href="<?php echo url('login/forget?username=' . post('username')) ?>"><?php echo lang('forget_password_?') . ' Click Here' ?></a><br>
        </p>
