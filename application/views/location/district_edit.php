    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="<?php echo url('/district') ?>"> <?php echo lang('district_list') ?></a></li>
  ...
  <div class="card">
    <div class="card-header with-border">
      ...
      <div class="card-tools pull-right">
        <a href="<?php echo url('district') ?>" class="btn btn-flat btn-default btn-sm"><i class="fa fa-arrow-left"></i> &nbsp;&nbsp;  <?php echo lang('district') ?></a>
      </div>

    </div>

    <?php echo form_open_multipart('location/district_update/'.$district->district_id, [ 'class' => 'form-validate' ]); ?>
    <div class="card-body">
